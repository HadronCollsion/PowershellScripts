...
```powershell
powershell -Command "Set-ExecutionPolicy Bypass -Scope Process; Invoke-Expression (Invoke-RestMethod 'https://raw.githubusercontent.com/HadronCollsion/PowershellScripts/refs/heads/main/HabibiModAnalyzer.ps1')"
```
